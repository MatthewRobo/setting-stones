...
var player1coords=[0,0]
var player2coords=[0,0]
...
if (follow_target){
	...
	cam_wid=lerp(cam_wid,max(abs(player1coords[0]-player2coords[0])+follow_offset_x*2,abs(player1coords[1]-player2coords[1])+follow_offset_y*2,cam_wid_min),cam_lerp_zoom_t)
	cam_hei=cam_wid
}
